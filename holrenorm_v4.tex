...
\ben
{\rm PolyDiff}^{hol}(\sV_1^{hol} \times \cdots \times \sV_n^{hol}, \sW^{hol}) \cong {\rm Hom}(J^ {hol}(V_1) \tensor \ldots \tensor J^{hol}(V_n), W) .
\een
...
\be\label{weight2}
\begin{array}{cc}
\int_{w^k \in \CC^d} \d^{d} w^k & \displaystyle \int_{(w_1,\ldots,w_{k-1}) \in (\CC^d)^{k-1}} \left(\prod_{\alpha=1}^{k-1} \d^{d} w^\alpha\right) \Phi(w^1,\ldots,w^k) \left(\prod_{\alpha=1}^{k-1} \left(\frac{\partial}{\partial w^\alpha}\right)^{\vec{n}^\alpha}P^{an}_{\epsilon < L} (w^\alpha) \right) 
\\ & \displaystyle \times \sum_{\alpha=1}^{k-1} \left(\frac{\partial}{\partial w^\alpha}\right)^{\vec{n}^k} P^{an}_{\epsilon<L} \left(\sum_{\alpha=1}^{k-1} w^\alpha\right) .
\end{array}
\ee
...
\ben
\begin{array}{lll}
& \displaystyle \int_{w^k \in \CC^d} \d^{2d} w^k \int_{(w_1,\ldots,w_{k-1}) \in (\CC^d)^{k-1}} \left(\prod_{\alpha=1}^{k-1} \d^{2d} w^\alpha\right) \Phi(w^1,\ldots,w^k) \int_{(t_1,\ldots,t_k) \in [\epsilon,L]^k} \prod_{\alpha=1}^k \frac{\d t_\alpha}{(2 \pi i t_\alpha)^d} \\
...
\ben
\begin{array}{lll}
& \displaystyle \pm \int_{w^k \in \CC^d} \d^{2d} w^k \int_{(w_1,\ldots,w_{k-1}) \in (\CC^d)^{k-1}}\left(\prod_{\alpha=1}^{k-1} \d^{2d} w^\alpha\right) \int_{(t_1,\ldots,t_k) \in [\epsilon,L]^k} \prod_{\alpha=1}^k \frac{\d t_\alpha}{(2 \pi i  t_\alpha)^d}  \\ 
...
\begin{array}{cccl}
\displaystyle|W_{\epsilon < L}^{k, (n)}(\Phi)| & \leq & C & \displaystyle \int_{w^k \in \CC^d} \d^{2d} w^k \int_{(w^1,\ldots,w^{k-1}} \prod_{\alpha=1}^{k-1} \d^{2d} w^\alpha \Psi(w^1,\ldots,w^{k-1},w^k) \\ & & \times & \displaystyle \int_{(t_1,\ldots,t_k) \in [\epsilon,L]^k} \d t_1 \ldots \d t_k \frac{1}{(4\pi)^{dk}} \frac{1}{t^d_1\cdots t^d_k} \times E(w,t)
\end{array}
\ee
...
\ben
\begin{array}{lll}
\Tilde{W}_{\epsilon < L}^{k, (n)}(\Phi) & = \displaystyle \int_{w^k \in \CC^d} \d^{2d} w^k \int_{(w_1,\ldots,w_{k-1}) \in (\CC^d)^{k-1}} \left(\prod_{\alpha=1}^{k-1} \d^{2d} w^\alpha\right) \Phi(w^1,\ldots,w^k) \\ & \times \displaystyle \int_{(t_1,\ldots,t_k) \in [\epsilon,L]^{k-1}} \frac{1}{(2 \pi i \epsilon)^d} \prod_{\alpha=1}^{k-1} \frac{\d t_\alpha}{(2 \pi i t_\alpha)^d} \\
...
\ben
\begin{array}{lll}
\Tilde{W}_{\epsilon < L}^{k, (n)}(\Phi) & = \displaystyle \pm \int_{w^k \in \CC^d} \d^{2d} w^k \int_{(w_1,\ldots,w_{k-1}) \in (\CC^d)^{k-1}}\left(\prod_{\alpha=1}^{k-1} \d^{2d} w^\alpha\right) \\ & \times \displaystyle \int_{(t_1,\ldots,t_{k-1}) \in [\epsilon,L]^{k-1}} \frac{1}{(2 \pi i \epsilon)^d} \prod_{\alpha=1}^{k-1} \frac{\d t_\alpha}{(2 \pi i t_\alpha)^d}  \\ 
