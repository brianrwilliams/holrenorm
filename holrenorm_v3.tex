...
This particular class of theories has been discussed in Chapter \brian{ref} of \cite{CG2}, and we recall some of the definitions here.
It will be a very special case of a general holomorphic theory as defined above. 
Our main result is a classification of the local deformation complex for holomorphic translation invariant theories. 
...
\brian{fix this given our conventions above}
...
\een
where $F : V^{\tensor k} \to \CC$ is a linear map and each $D_\alpha$ is an operator in the space 
\ben
...
We see that the {\em obstruction} to satisfying the quantum master equation order by order in $\hbar$ is given by the following inductive definition.
...
Throughout this section we fix a classical holomorphic theory $(V, Q^{hol}, (-,-)_V, I^{hol})$ on $\CC^d$.
...
Let $I[L] = \lim_{\epsilon \to 0} W(P_{\epsilon<L}, I) \mod \hbar^2$ be the one-loop renormalization group flow using the propagator defined in Section \ref{sec: propagator}.
